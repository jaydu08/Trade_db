...
| `daily_summary` | 工作日 19:00 | 每日综合汇总TXT（A股Trend日榜 + 港/美Heatmap + 大宗商品） |
...
- A股：复用 Heatmap 页面 `Trend算法榜(days=1)`，默认 `12` 支，市值分层为 `large>=1200亿 / mid=400~1200亿 / small=1~400亿`，默认配额 `4/4/4`
